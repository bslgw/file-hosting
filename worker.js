...
function generateHTML(files) {
  ...
  html += '        .upload-progress { margin-bottom: 25px; display: none; width: 100%; background: white; padding: 15px 25px; border-radius: 16px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); box-sizing: border-box; }\n';
  html += '        .progress-bar { width: 100%; height: 8px; background: #e0e0e0; border-radius: 4px; overflow: hidden; }\n';
  ...
  html += '            <p id="progressText" style="margin-bottom: 10px; text-align: left; font-size: 13px; color: #555; font-weight: 500;"></p>\n';
